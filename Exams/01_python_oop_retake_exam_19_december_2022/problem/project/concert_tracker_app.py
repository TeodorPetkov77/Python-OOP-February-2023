...
class ConcertTrackerApp:
    ...
    def create_concert(self, genre: str, audience: int, ticket_price: float, expenses: float, place: str):
        registered_genre = [c for c in self.concerts if c.place == place]

        if registered_genre:
            raise Exception(f"{place} is already registered for {registered_genre[0].genre} concert!")
...
# https://judge.softuni.org/Contests/Practice/Index/3622#1
