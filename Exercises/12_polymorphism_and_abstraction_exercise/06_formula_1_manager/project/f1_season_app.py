...
class F1SeasonApp:
    ...
    def new_race_results(self, race_name: str, red_bull_pos: int, mercedes_pos: int):
        ...
        fastest_team = "Red Bull" if red_bull_pos < mercedes_pos else "Mercedes"
        return f"Red Bull: {self.red_bull_team.calculate_revenue_after_race(red_bull_pos)}. " \
               ...
               f"{fastest_team} is ahead at the {race_name} race."


# https://judge.softuni.org/Contests/Compete/Index/1943#5
